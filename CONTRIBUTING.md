# Contributing to Website Bugfix Sprint

Website Bugfix Sprint is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A website bugfix sprint demo with reproduction steps, responsive checks, fix logs, and acceptance criteria.
